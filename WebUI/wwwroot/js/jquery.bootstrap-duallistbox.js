...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Mover el seleccionado',
      moveAllLabel: 'Mover todo',
      removeSelectedLabel: 'Quitar el seleccionado',
      ...
      infoText: 'Mostar todo {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="badge badge-warning">Encontrado </span> {0} de {1}', // when not all of the options are visible due to the filter
